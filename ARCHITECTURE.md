...
NEXUS is a production-grade multi-LLM orchestration system that intelligently routes queries to the optimal model from a pool of 7 LLMs. The core principle: **not every query needs an expensive model**.
